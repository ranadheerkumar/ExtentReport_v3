...
public class ExtentReportDemo 
{
	...
	{    
	    ...
	    logger2.fail("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("D:\\Eclipse_Development\\extentReport.jpg").build());
        
	    logger2.pass("Failed because of some issues", MediaEntityBuilder.createScreenCaptureFromPath("D:\\Eclipse_Development\\extentReport.jpg").build());
